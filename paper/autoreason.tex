...
\usepackage{ebgaramond}            % EB Garamond text
\usepackage[cmintegrals,cmbraces]{newtxmath} % Math compatible with Garamond
...
\node[font=\scriptsize, text=MedGray, rotate=90, anchor=south]
    at ([xshift=-2.0cm, yshift=-1.2cm]A.west) {winner $\to$ new A};
...
\bibitem{llmcouncil} J. Huang et al. ChatGPT's one-year anniversary: Are open-source large language models catching up? \textit{arXiv preprint \href{https://arxiv.org/abs/2311.16989}{arXiv:2311.16989}}, 2023. (Introduces the ``LLM Council'' multi-model panel evaluation approach.)
...
\bibitem{verdict} R. Nair et al. Verdict: Scalable judge-time compute via hierarchical verification. \textit{\href{https://arxiv.org/abs/2502.18018}{arXiv:2502.18018}}, 2025.
